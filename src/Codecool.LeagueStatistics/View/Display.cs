...
namespace Codecool.LeagueStatistics.View
{
    ...
    public static class Display
    {
        public static void LeagueResult(IEnumerable<Team> teams)
        {
            ...
            {
                table.AddRow($"{counter}.", team.Name, team.CurrentPoints, team.Players.Sum(player => player.Goals),
                    team.Wins, team.Draws, team.Losts);
                counter++;
            }
        ...
        public static void SingleMatchResult(Team team1, Team team2)
        {
            ...
            table.AddRow(team1.Name, team1.CurrentPoints, team1.Players.Sum(player => player.Goals), team1.Wins,
                team1.Draws, team1.Losts);
            table.AddRow(team2.Name, team2.CurrentPoints, team2.Players.Sum(player => player.Goals), team2.Wins,
                team2.Draws, team2.Losts);
